...
import client.operations.{Operation, OperationRegistry, OperationToken}
...
class MidiOperations @Inject() (
  ...
  registry.registerOperation(OperationToken("devices", "midi"), () => {
  ...
  registry.registerOperation(OperationToken("patchboard", "midi"), () => {
