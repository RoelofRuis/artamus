...
package object track {
  ...
  case class CreateKeySymbol(position: Position, symbol: SymbolProperties[Key.type]) extends Command
  case class CreateTimeSignatureSymbol(position: Position, symbol: SymbolProperties[TimeSignature.type]) extends Command
